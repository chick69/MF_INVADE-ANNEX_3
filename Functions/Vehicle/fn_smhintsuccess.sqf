...
if (_reward isKindOf "Rabbit_F") then {
	...
	_reward = createVehicle ["B_Heli_Light_01_armed_F", getMarkerPos "smReward1",smMarkerList,0,"NONE"];
	_reward removeMagazine ("5000Rnd_762x51_Belt");
	_reward removeWeapon ("M134_minigun");
	_reward addWeapon ("HMG_127_APC");
	_reward addMagazine ("500Rnd_127x99_mag_Tracer_Red");
	_skin = selectRandom [
	'A3\Air_F\Heli_Light_01\Data\Heli_Light_01_ext_BLUFOR_CO.paa',
	'A3\Air_F\Heli_Light_01\Data\Heli_Light_01_ext_ION_CO.paa',
	'A3\Air_F\Heli_Light_01\Data\skins\Heli_Light_01_ext_wasp_co.paa',
...
if (_reward isKindOf "Land_GarbageBags_F") then {
	...
	_reward removeMagazine ("5000Rnd_762x51_Belt");
	_reward removeWeapon ("M134_minigun");
	_reward addWeapon ("GMG_20mm");
	_reward addMagazine ("40Rnd_20mm_G_belt");
	_reward addMagazine ("40Rnd_20mm_G_belt");
	_skin = selectRandom [
	'A3\Air_F\Heli_Light_01\Data\Heli_Light_01_ext_BLUFOR_CO.paa',
	'A3\Air_F\Heli_Light_01\Data\Heli_Light_01_ext_ION_CO.paa',
...
if (_reward isKindOf "Land_NetFence_01_m_pole_F") then {
	...
	deleteVehicle _reward;
	_reward = createVehicle ["I_Heli_light_03_F", getMarkerPos "smReward1",smMarkerList,0,"NONE"];
	_reward setObjectTextureGlobal [0, "\a3\air_F_EPB\Heli_Light_03\Data\Heli_Light_03_base_CO.paa"]; 
	_reward removeMagazinesTurret ["24Rnd_missiles",[-1]];
