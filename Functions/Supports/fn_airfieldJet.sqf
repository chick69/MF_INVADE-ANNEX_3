...
if ("AO_AAC_Airfield" in controlledZones) then {
	_airField = _airField - ["AAC_CAS_Spawn"];
};
if ("AO_Terminal" in controlledZones) then {
	_airField = _airField - ["Airbase_CAS_Spawn"];
};
if ("AO_Salt_Flats_North" in controlledZones) then {
	_airField = _airField - ["SaltLake_CAS_Spawn"];
};
if ("AO_Molos_Airfield" in controlledZones) then {
