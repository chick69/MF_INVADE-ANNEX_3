...
switch (_base) do {
	case "AO_Terminal":{
        ...
        //arsenal box actions
        [_arsenal, ["<t color='#127a00'>Teleport To FOB Martian</t>","cutText ['','BLACK OUT'];sleep 2;[player,'AO_AAC_Airfield'] remoteExec ['AW_fnc_baseTeleport',2];sleep 1; cutText ['','BLACK IN'];","",-85,false,true,"","('AO_AAC_Airfield' in controlledZones)"]] remoteExec ["addAction", -2, true];
        [_arsenal, ["<t color='#127a00'>Teleport To FOB Marathon</t>","cutText ['','BLACK OUT'];sleep 2;[player,'AO_Stadium'] remoteExec ['AW_fnc_baseTeleport',2];sleep 1; cutText ['','BLACK IN'];","",-86,false,true,"","('AO_Stadium' in controlledZones)"]] remoteExec ["addAction", -2, true];
        [_arsenal, ["<t color='#127a00'>Teleport To FOB Dirt Track</t>","cutText ['','BLACK OUT'];sleep 2;[player,'AO_Selakano_Town'] remoteExec ['AW_fnc_baseTeleport',2];sleep 1; cutText ['','BLACK IN'];","",-87,false,true,"","('AO_Selakano_Town' in controlledZones)"]] remoteExec ["addAction", -2, true];
        [_arsenal, ["<t color='#127a00'>Teleport To FOB Last Stand</t>","cutText ['','BLACK OUT'];sleep 2;[player,'AO_Molos_Airfield'] remoteExec ['AW_fnc_baseTeleport',2];sleep 1; cutText ['','BLACK IN'];","",-88,false,true,"","('AO_Molos_Airfield' in controlledZones)"]] remoteExec ["addAction", -2, true];
    };
	
	case "AO_AAC_Airfield":{
        ...
        [_arsenal, ["<t color='#127a00'>Teleport To FOB Marathon</t>","cutText ['','BLACK OUT'];sleep 2;[player,'AO_Stadium'] remoteExec ['AW_fnc_baseTeleport',2];sleep 1; cutText ['','BLACK IN'];","",-85,false,true,"","('AO_Stadium' in controlledZones)"]] remoteExec ["addAction", -2, true];
        [_arsenal, ["<t color='#127a00'>Teleport To FOB Dirt Track</t>","cutText ['','BLACK OUT'];sleep 2;[player,'AO_Selakano_Town'] remoteExec ['AW_fnc_baseTeleport',2];sleep 1; cutText ['','BLACK IN'];","",-86,false,true,"","('AO_Selakano_Town' in controlledZones)"]] remoteExec ["addAction", -2, true];
        [_arsenal, ["<t color='#127a00'>Teleport To FOB Last Stand</t>","cutText ['','BLACK OUT'];sleep 2;[player,'AO_Molos_Airfield'] remoteExec ['AW_fnc_baseTeleport',2];sleep 1; cutText ['','BLACK IN'];","",-87,false,true,"","('AO_Molos_Airfield' in controlledZones)"]] remoteExec ["addAction", -2, true];
        [_arsenal, ["<t color='#127a00'>Teleport To FOB Guardian</t>","cutText ['','BLACK OUT'];sleep 2;[player,'AO_Terminal'] remoteExec ['AW_fnc_baseTeleport',2];sleep 1; cutText ['','BLACK IN'];","",-88,false,true,"","('AO_Terminal' in controlledZones)"]] remoteExec ["addAction", -2, true];
    };
