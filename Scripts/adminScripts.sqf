...
MMFOBAltis = [
	["Altis FOBs",true],  
	["AAC_Airfield",   	[2], "", -5, [["expression", "newBase = 'AO_AAC_Airfield';	 if !(newBase in controlledZones) then {publicVariable 'newBase'; FobName = {controlledZones pushBack newBase;}; publicVariable 'FobName'; remoteExecCall ['FobName',0]; FI2 = {[newBase] call AW_fnc_BaseManager;}; publicVariable 'FI2'; remoteExecCall ['FI2',2]; cutText['FOB spawned', 'PLAIN'];} else {cutText['FOB has already been spawned', 'PLAIN'];};" ]],"", ""],
	["Stadium",   		[3], "", -5, [["expression", "newBase = 'AO_Stadium';		 if !(newBase in controlledZones) then {publicVariable 'newBase'; FobName = {controlledZones pushBack newBase;}; publicVariable 'FobName'; remoteExecCall ['FobName',0]; FI2 = {[newBase] call AW_fnc_BaseManager;}; publicVariable 'FI2'; remoteExecCall ['FI2',2]; cutText['FOB spawned', 'PLAIN'];} else {cutText['FOB has already been spawned', 'PLAIN'];};" ]],"", ""],
	["Molos_Airfield",	[4], "", -5, [["expression", "newBase = 'AO_Molos_Airfield';if !(newBase in controlledZones) then {publicVariable 'newBase'; FobName = {controlledZones pushBack newBase;}; publicVariable 'FobName'; remoteExecCall ['FobName',0]; FI2 = {[newBase] call AW_fnc_BaseManager;}; publicVariable 'FI2'; remoteExecCall ['FI2',2]; cutText['FOB spawned', 'PLAIN'];} else {cutText['FOB has already been spawned', 'PLAIN'];};" ]],"", ""],
	["Terminal",   		[5], "", -5, [["expression", "newBase = 'AO_Terminal';		 if !(newBase in controlledZones) then {publicVariable 'newBase'; FobName = {controlledZones pushBack newBase;}; publicVariable 'FobName'; remoteExecCall ['FobName',0]; FI2 = {[newBase] call AW_fnc_BaseManager;}; publicVariable 'FI2'; remoteExecCall ['FI2',2]; cutText['FOB spawned', 'PLAIN'];} else {cutText['FOB has already been spawned', 'PLAIN'];};" ]],"", ""],
