...
if (_accepted) then {
	...
	[west,["SubAoTask"],["We have received intel from local resistance fighters that OPFOR have hidden a weapons cache in the area. Take it out and expect it to be guarded."
	...
	waitUntil {sleep 5; !alive ammoCrate || !missionActive || ammoCrate == objNull};
