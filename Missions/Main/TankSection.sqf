...
[_targetStartText] remoteExec ["AW_fnc_globalHint",0,false];
[west,["SubAoTask"],["OPFOR have called in a T-100 section.  Find and destroy these MBTs, they must not survive this AO.","T-100 section","radioMarker"],(getMarkerPos "radioMarker"),"Created",0,true,"destroy",true] call BIS_fnc_taskCreate;
