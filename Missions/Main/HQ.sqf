...
[west,["SubAoTask"],["OPFOR have set up an HQ building in the AO. Inside is an officer, neutralise him using any force necessary","HQ Building","radioMarker"],(getMarkerPos "radioMarker"),"Created",0,true,"destroy",true] call BIS_fnc_taskCreate;
