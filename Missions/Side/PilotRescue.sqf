...
modified: rewrote to spawn teh asset in instead of moving him around all the time
...
while {_numPlayersnear < 1 && sideMissionUp}do
{
...
while {sideMissionUp} do {
    ...
    _bleedOutTimer = _bleedOutTimer -2;
    sleep 2;
